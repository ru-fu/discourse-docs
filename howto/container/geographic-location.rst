...
``/var/lib/anbox/static_gps_position`` via an :ref:`addon install hook <manage-addons-heading--build-your-own-addon>`
...
See the documentation of the :ref:`PATCH method <reference_ams-http-api-location-patch>`

...
-  ```/1.0:ref:`` <reference_anbox-http-api-heading--10>`

   -  ```/1.0/location:ref:`` <reference_anbox-http-api-heading--10location>`
   -  ```/1.0/camera:ref:`` <reference_anbox-http-api-heading--10camera>`

      -  ```/1.0/camera/data:ref:`` <reference_anbox-http-api-heading--10cameradata>`

   -  ```/1.0/sensors:ref:`` <reference_anbox-http-api-heading--10sensors>`
   -  ```/1.0/tracing:ref:`` <reference_anbox-http-api-heading--10tracing>`

...
.. list-table::
   ...
   * - \ `Getting started with Anbox Cloud (web dashboard) <https://discourse.ubuntu.com/t/getting-started-with-anbox-cloud-web-dashboard/24958>`__\

       \ `Getting started with Anbox Cloud (CLI) <https://discourse.ubuntu.com/t/getting-started/17756>`__\
